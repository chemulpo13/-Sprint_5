...
class RegisterPage(BasePage):
    ...
    @allure.title("Регистрация пользователя с именем: '{name}', email: '{email}'")
    ...
    @allure.title("Переход со страницы регистрации на страницу входа")
    ...
    @allure.title("Проверка отображения ошибки пароля")
